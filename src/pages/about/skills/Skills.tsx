...
import { Box, Flex, Text, useColorModeValue, Wrap, WrapItem, Container } from "@chakra-ui/react";
...
export const Skills: FC = () => {
    ...
    const boxShadowHover = useColorModeValue("0 12px 24px rgba(0, 0, 0, 0.06)", "0 12px 24px rgba(0, 0, 0, 0.3)");
            ...
            <Container maxW="container.xl" px={{ base: 4, md: 6, lg: 4 }}>
                ...
                <Flex wrap="wrap" gap={4} rowGap={6} justify={{ base: "center", md: "space-between" }}>
                    {configs.about.skills.map((section, index) => (
                        ...
                        >
                            <Text fontSize={{ base: "lg", sm: "xl" }} fontWeight="bold" mb={4}>
                                {section.title}
                            </Text>
                            ...
                            <Wrap spacing={4} justify={{ base: "start", sm: "flex-start" }}>
                                {section.tools.map((tool) => (
                                    ...
                                    >
                                        <SkillSvgIcon name={tool.name} svgUrl={convertToSvgUrl(tool.iconClass)} />
                                    </WrapItem>
                                ))}
                            </Wrap>
                        </Box>
